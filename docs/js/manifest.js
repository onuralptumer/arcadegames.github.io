...
export const GAMES = [
    {
        ...
        tint: '#F7D3C6',
        ready: true,
        load: () => import('./games/deflekt/index.js?v=51ac2eb329'),
    },
    {
        slug: 'kivrim',
        name: 'Kıvrım',
        ...
        tint: '#B4E7D6',
        ready: true,
        load: () => import('./games/kivrim/index.js?v=51ac2eb329'),
    },
    {
        slug: 'suzul',
        name: 'Süzül',
        ...
        tint: '#FBDCA9',
        ready: true,
        load: () => import('./games/suzul/index.js?v=51ac2eb329'),
    },
    {
        slug: 'yigin',
        name: 'Yığın',
        ...
        tint: '#D6D3F8',
        ready: true,
        load: () => import('./games/yigin/index.js?v=51ac2eb329'),
    },
    {
        slug: 'nobet',
        name: 'Nöbet',
        ...
        tint: '#C4DDF6',
        ready: true,
        load: () => import('./games/nobet/index.js?v=51ac2eb329'),
    },
    {
        slug: 'katla',
        name: 'Katla',
        ...
        tint: '#F6CDDB',
        ready: true,
        load: () => import('./games/katla/index.js?v=51ac2eb329'),
    },
    {
        slug: 'savruk',
        name: 'Savruk',
        ...
        tint: '#D2D2DA',
        ready: true,
        load: () => import('./games/savruk/index.js?v=51ac2eb329'),
    },
    {
        slug: 'dolambac',
        name: 'Dolambaç',
        ...
        tint: '#F2E1AE',
        ready: true,
        load: () => import('./games/dolambac/index.js?v=51ac2eb329'),
    },
    {
        slug: 'kume',
        name: 'Küme',
        ...
        tint: '#B7E2E2',
        ready: true,
        load: () => import('./games/kume/index.js?v=51ac2eb329'),
    },
    {
        slug: 'gecit',
        name: 'Geçit',
        ...
        tint: '#E4C9B4',
        ready: true,
        load: () => import('./games/gecit/index.js?v=51ac2eb329'),
    },
    {
        slug: 'kalkan',
        name: 'Kalkan',
        ...
        tint: '#EFC0CE',
        ready: true,
        load: () => import('./games/kalkan/index.js?v=51ac2eb329'),
    },
    {
        slug: 'sekme',
        name: 'Sekme',
        ...
        tint: '#CBE5C0',
        ready: true,
        load: () => import('./games/sekme/index.js?v=51ac2eb329'),
    },
];
